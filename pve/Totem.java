...
import me.skylands.skypvp.task.BossAttackTask;
import org.bukkit.*;
...
public class Totem {
    ...
    final Helper entityManager = new Helper();

    public Totem(Location centerLocation, int difficulty, int spawnRadius, List<EntityType> enemies, String bossType) {
    ...
    public void spawnBoss() {
        ...
        switch (this.bossType) {
            case "Slime":
                if(!this.entityManager.isBossAlive("Slime")) {
                    ...
                    Bukkit.getScheduler().runTaskTimer(SkyLands.plugin, new BossAttackTask(bossSlime, new DestroyItemAttack()), 20, 20);
                }
                break;
            /*[...]":*/
        }
